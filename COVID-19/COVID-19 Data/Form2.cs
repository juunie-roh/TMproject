        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (listBox1.SelectedIndex)
            {
                case 0://인데스에 따른 변화 감지
                    textBox1.Text = "비인두도말 PCR검사는 표준검사법으로 주로 시행하는 검사입니다.\r\n\r\n먼저 검사소에 방문해 문진표를 작성합니다. 그 후에 검체 채취소에서 코와 목에 긴 면봉을 넣어 분비물을 채취합니다.\r\n\r\n검사 결과는 빠르면 당일 밤, 보통은 다음 날 결과가 나옵니다.";//텍스트 박스 내용 설정
                    pictureBox1.Load("pcr1.jpg");//이미지 설정
                    pictureBox1.SizeMode = PictureBoxSizeMode.StretchImage;
                    break;

                case 1://인데스에 따른 변화 감지
                    textBox1.Text = "타액 PCR검사는 기존 PCR검사에서 비인두 검체 대신 침을 이용하는 점만 다릅니다.\r\n\r\n채취에 드는 노력과 시간이 줄어드는 장점이 있지만, 비인두도말 PCR검사보다 민감도가 떨어집니다.\r\n\r\n보통 24시간 이내에 검사 결과가 나오게 됩니다.";//텍스트 박스 내용 설정
                ...
                case 3://인데스에 따른 변화 감지
                    textBox1.Text = "자가 진단 키트는 약국과 온라인 쇼핑몰에서 판매합니다.\r\n\r\n면봉을 콧속에 넣는 방식이지만 비인두도말 방식보다는 좀 더 앞쪽에서 검체를 채취합니다.\r\n\r\n검사결과까지는 약 15분 정도가 소요되며, 정확도가 떨어져 코로나 방역체계를 혼란을 초래할 수도 있다는 전문가들의 우려가 있습니다.";//텍스트 박스 내용 설정
